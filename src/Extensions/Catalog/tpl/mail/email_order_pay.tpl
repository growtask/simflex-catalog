...
<tr>
    <td>
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="
          ...
          ">
                                    Заказ №<?=$order->order_id?> ожидает оплаты
                                </h4>
                            </td>
                        </tr>
          ...
          ">Статус заказа:</span>
                            ...
                            <td
                                style="padding: 9.5px 16px; background-color: #9655f2; border-radius: 12px">
                                <span style="
            font-family: 'Arial', 'Noto Sans', sans-serif;
            font-style: normal;
            font-weight: 600;
          ...
          ">Ожидает оплаты</span>
                        ...
                        <tr>
                            <td style="padding: 12px 0;">
                                <table style="width: 400px;" cellpadding="0" cellspacing="0"
                                    border="0">
                                    <tr>
                                        <td style="font-family: 'Arail', 'Noto Sans', sans-serif;
            font-size: 14px;
            font-style: normal;
            font-weight: 400;
            line-height: 150%;
            ...
            ">
                                            ...
                                            <br>
                                            <br>
                                            Спасибо, что оформили заказ в нашем интернет-магазине.
                                            При <strong>изменении
