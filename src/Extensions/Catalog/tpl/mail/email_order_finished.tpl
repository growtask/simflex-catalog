...
<!-- Email Message Order Finished Content -->
            ...
            <tr>
                <td style="padding: 40px">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr style="display: table-cell">
                          ...
                          <span style="
                            ...
                            <td
                                    style="padding: 9.5px 16px; background: linear-gradient(90deg, #7318F2 0%, #30B2F2 100%); border-radius: 12px">
                          <span style="
                                font-family: 'Arial', 'Noto Sans', sans-serif;
                                font-style: normal;
                                font-weight: 600;
                        ...
                        <tr>
                            <td style="padding: 12px 0;">
                                ...
                                ">
                                            ...
                                            <br>
                                            <br>
                                            Спасибо за то, что пользуетесь услугами нашего интернет-магазина! Ждём вас
                                            за новыми
                                            заказами!
                                        </td>
                                    </tr>
                    ...
                    margin: 0;">
                        ...
                        <?php $isBlockOnTop = true; include 'order/place.tpl'; ?>
                        ...
                        <!-- Order Info -->
                        <?php $isBlockOnTop = true; include 'order/info.tpl'; ?>
                        <!-- End Order Info  -->
                        <!-- Cart items -->
