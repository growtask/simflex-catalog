                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr style="display: table-cell">
                          ...
                          <span style="
                            ...
                            <td style="padding: 9.5px 16px; background-color: #5b13bf; border-radius: 12px">
                          <span style="
                                font-family: 'Arial', 'Noto Sans', sans-serif;
                                font-style: normal;
                                font-weight: 600;
                        ...
                        <tr>
                            <td style="padding: 12px 0;">
                                ...
                                ">
                                            ...
                                            Ваш заказ доставлен и вы можете забрать его в месте получения. Нажмите на
                                            кнопку, чтобы
                                            узнать, где можно получить заказ
                                        </td>
                                    </tr>
                                </table>
                            </td>
